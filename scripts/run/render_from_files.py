...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Render episodes using final policy of run read from provided directory.")
    ...
    parser.add_argument("--torch_num_threads", default=None, type=int,
    ...
    parser.add_argument("--test", default=False, action="store_true",
                        help="Whether to show testing or training episode.")
